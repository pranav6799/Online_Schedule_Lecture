...
//     try {
//       const response = await axios.get('http://localhost:6001/api/v1/course/get',{
//         headers:{
...
//   try{
//     const response = await axios.get(`http://localhost:6001/api/v1/user/getAllInstructor`,{
//   headers:{
//     'Authorization':auth?.token
//   }  
// })
...
//   try {
//     const response = await axios.get(`http://localhost:6001/api/v1/schedule/getSchedule/${courseId}`, {
//       headers: {
//         'Authorization': auth?.token
//       }
//     });
...
//     const response = await axios.post(`http://localhost:6001/api/v1/schedule/add`,lectureData,{
//       headers:{
//         Authorization:auth?.token
//       }
//     })
...
if(response.data.status){
  ...
  const checkAvailability = async () => {
    try {
      const response = await axios.post('http://localhost:6001/api/v1/schedule/checkAvailability', {
        date,
        instructor,
      }, {
        headers: {
